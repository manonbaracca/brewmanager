      ...
      <div style={{ flex:1, display:'flex', alignItems:'center', justifyContent:'center', width:'100%', padding:'1rem', boxSizing:'border-box' }}>
        <div className="card shadow-sm border-0 w-100" style={{ maxWidth: '500px' }}>
          ...
          <div className="card-body bg-white p-4">
            ...
            <form onSubmit={handleSubmit}>
              <div className="mb-3">
                ...
                <input id="username" name="username" className="form-control" value={formData.username} onChange={handleChange} required />
              </div>
              <div className="mb-3">
              ...
              <div className="mb-3">
                ...
                <input id="password1" name="password1" type="password" className="form-control" value={formData.password1} onChange={handleChange} required />
              </div>
              <div className="mb-3">
                <label htmlFor="password2" className="form-label">Confirmar Contraseña</label>
                <input id="password2" name="password2" type="password" className="form-control" value={formData.password2} onChange={handleChange} required />
              </div>
              <button type="submit" className="btn w-100 text-white fw-bold mt-3" style={{ backgroundColor: '#8B4513' }}>
                Crear Cuenta
              </button>
            </form>
          </div>
          <div className="card-footer text-center" style={{ backgroundColor: '#FFFFFF' }}>
            <small>
              ¿Ya tienes cuenta?{' '}
              <Link to="/login" className="text-decoration-none" style={{ color: '#5A2E1B' }}>
                Inicia sesión
              </Link>
            </small>
          </div>
