...
export default function ProductUpdate() {
  ...
  const [form, setForm] = useState({ nombre:'', categoria:'', cantidad:0 })
  ...
  const handleSubmit = async e => {
    e.preventDefault()
    try {
      await axios.put(`/api/productos/${id}/`, form, { withCredentials:true })
      nav('/producto', { state: { successMessage: 'Producto actualizado.' } })
    } catch {
              ...
              <div className="card-body" style={{ backgroundColor:'#F5DEB3' }}>
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="d-flex justify-content-between mt-4">
                    <button type="button" className="btn" onClick={() => nav('/producto')} style={{
