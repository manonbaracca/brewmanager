...
from user.views import (
    ajustes, ajustes_categorias, agregar_categoria, editar_categoria, eliminar_categoria
)
...
urlpatterns = [
    ...
    path('staff/delete/<int:pk>/',   views.staff_delete,    name='dashboard-staff-delete'),  # <–– aquí
